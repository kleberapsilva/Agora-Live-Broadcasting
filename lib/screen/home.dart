...
class _HomePageState extends State<HomePage> {
  ...
  Live liveUser;
  var name;
  var image = 'https://i.pravatar.cc/150?img=3';
  var username;
  var postUsername;
  ...
  Future<void> loadSharedPref() async {
    ...
    setState(() {
      ...
      image = prefs.getString('image') ?? 'https://i.pravatar.cc/150?img=3';
    });
  }

  void dbChangeListen() {
    databaseReference.collection('liveuser').orderBy("time", descending: true).snapshots().listen((result) {
      ...
      result.docs.forEach((result) {
        setState(() {
          list.add(new Live(username: result['name'], image: result['image'], channelId: result['channel'], me: false));
        });
      });
    });
  }
                  ...
                  children: <Widget>[
                    !users.me
                        ? Container(
                            ...
                            width: 60,
                            child: Container(
                              decoration: BoxDecoration(shape: BoxShape.circle, gradient: LinearGradient(colors: [Colors.indigo, Colors.blue, Colors.cyan], begin: Alignment.topLeft, end: Alignment.bottomRight)),
                            ),
                          )
                        : SizedBox(
                            height: 0,
                              ...
                              children: <Widget>[
                                Container(
                                  ...
                                  decoration: new BoxDecoration(
                                    ...
                                    gradient: LinearGradient(colors: [Colors.black, Colors.black], begin: Alignment.centerLeft, end: Alignment.centerRight),
                                  ),
                                ),
                                Container(
                                    decoration: new BoxDecoration(
                                      ...
                                      gradient: LinearGradient(colors: [Colors.indigo, Colors.blueAccent], begin: Alignment.centerLeft, end: Alignment.centerRight),
                                    ),
                                    child: Padding(
